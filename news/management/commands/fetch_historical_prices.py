...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--period', type=str, default='1mo', help='Período (ej. 1mo, 3mo, 1y)')
        parser.add_argument('--interval', type=str, default='1d', help='Intervalo (ej. 1d, 1wk)')
    ...
    def handle(self, *args, **kwargs):
        ...
        if df.empty:
            self.stdout.write(self.style.WARNING(f"No se encontraron datos para {symbol}"))
            return
        ...
        self.stdout.write(self.style.SUCCESS(f"Proceso completado. {registros_creados} registros nuevos añadidos."))