...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "ticker", type=str, help="Ticker symbol of the stock (e.g., MLGO)"
        )
        ...
        try:
            ...
            stock, created = Stock.objects.update_or_create(
                ...
                defaults={
                    ...
                    # Fechas como epoch
                    "compensationAsOfEpochDate": stock_info.get(
                    ...
                    "regularMarketPreviousClose": stock_info.get(
                    ...
                    "averageDailyVolume10Day": stock_info.get(
                    ...
                    "priceToSalesTrailing12Months": stock_info.get(
                    ...
                    "exchangeTimezoneShortName": stock_info.get(
            ...
            self.stdout.write(
                self.style.ERROR(f"Error fetching stock information: {e}")
            )
